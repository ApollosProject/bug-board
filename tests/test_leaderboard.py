...
class CycleProjectPointsTest(TestCase):
    ...
    def test_multiple_scoring_projects_fetch_assignees_in_one_call(self):
        leaderboard_module = _import_leaderboard_with_stub()
        projects = [
            {
                "id": "project-1",
        ...
        with patch.object(leaderboard_module, "get_projects", return_value=projects):
            with patch.object(
                ...
                return_value={
                    ...
                    "project-2": ["Later Page Contributor"],
                },
            ) as assignees_mock:
                lead_points, member_points = leaderboard_module.calculate_cycle_project_points(
                    30, now
        ...
        assignees_mock.assert_called_once_with(["project-1", "project-2"])
        self.assertEqual(lead_points, {"nick": 30, "austin": 30})
        self.assertEqual(member_points, {"Contributor": 15, "Later Page Contributor": 15})
